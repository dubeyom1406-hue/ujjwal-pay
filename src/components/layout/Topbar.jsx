...
import logoImg from '../../assets/images/logo-premium.png';

const TopbarLogo = () => (
  <div className="h-full w-full flex items-center justify-start pl-6">
    <img src={logoImg} alt="Ujjwal Pay" className="h-[80px] w-auto drop-shadow-md scale-[1.4] origin-left" style={{ objectFit: 'contain' }} />
  </div>
);

const Topbar = () => {
  return (
    <header className="h-[75px] bg-[#0c3182] border-b border-[#082464] flex items-center justify-between pr-6 shadow-md relative z-20 shrink-0">
      
      {/* Brand area aligns with Sidebar width closely */}
      <div className="flex items-center w-[280px] h-full shrink-0">
        <TopbarLogo />
      </div>
